...
(
  ...
  CREATE_ID   INT,
  MOD_ID      INT,
  FULL_NAME NVARCHAR(500)COLLATE Cyrillic_General_CI_AS_KS NOT NULL UNIQUE,
  COUNTRY INT,
  CURRENCY INT,
  EDRPOU NVARCHAR(14)COLLATE Cyrillic_General_CI_AS_KS NOT NULL UNIQUE,
